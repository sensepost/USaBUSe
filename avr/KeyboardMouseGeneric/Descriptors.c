...
RingBuffer_t *Debug_Buffer;

void dsc_initDebugBuffer(RingBuffer_t *buffer) {
	Debug_Buffer = buffer;
}
...
static inline void debug(char *Data) {
	...
	.HID1_ReportINEndpoint =
		{
			...
			.EndpointAddress        = HID1_IN_EPADDR,
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"Rogan Dawes");

/** Product descriptor string. This is a Unicode string containing the product's details in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"Universal Serial aBuse");
	...
	switch (DescriptorType)
	{
		...
		case HID_DTYPE_HID:
			...
			case INTERFACE_ID_KeyboardAndMouse:
				Address = &ConfigurationDescriptor.HID1_HIDData;
