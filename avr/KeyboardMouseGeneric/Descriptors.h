...
/* Type Defines: */
		...
		typedef struct
		{
			...
			USB_HID_Descriptor_HID_t              HID1_HIDData;
		...
		enum InterfaceDescriptors_t
		{
			...
			INTERFACE_ID_GenericHID = 1, /**< GenericHID interface descriptor ID */
		};
	...
	/* Macros: */
		...
		#define HID1_IN_EPADDR             (ENDPOINT_DIR_IN | 1)

		/** Endpoint address of the Generic HID reporting IN endpoint. */
		#define GENERIC_IN_EPADDR          (ENDPOINT_DIR_IN | 2)
